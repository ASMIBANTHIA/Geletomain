        ...
        <div className="main-headerone">
          <div className="firstheader">
            ...
            <div className="header-mid">
              ...
              <button
                className="contactheader  lidrop notdisplay2"
                onMouseEnter={() => toggleDropdown("INR")}
              ...
              <button className="contactheader notdisplay">
                ...
                <p className="boldheader">Sign in</p>
              </button>
          ...
          {isMenuOpen && (
            <div className="mobile-menu">
              <div className="mnubtn">
                ...
                <button
                  className="contactheader lidrop contactmob"
                  onMouseEnter={() => toggleDropdown("INR")}
                  onMouseLeave={() => toggleDropdown(null)}
                >
                  <Icon icon="material-symbols:globe" className="globe-icon" />
              ...
              <div className="mnubtn">
                <button className="cta-button ">Sign up for free</button>
                <button className="contactheader  contactmobone">
                  <Icon icon="iconamoon:profile-fill" className="globe-icon" />
                  <p className="boldheader ">Sign in</p>
                </button>
              </div>
              <div className="secondheader">
                <nav>
                  <ul>
                    ...
                    <li
                      className="lidrop"
                      onMouseEnter={() => toggleDropdown("start-selling")}
                      onMouseLeave={() => toggleDropdown(null)}
                    >
                    ...
                    <li className="lidrop">
                      <p className="boldheader">Pro Sellers</p>
                    </li>

                    <li
                      className="lidrop"
                      onMouseEnter={() => toggleDropdown("gelato-connect")}
                      onMouseLeave={() => toggleDropdown(null)}
                    >
        ...
        <div className="peakmenu">
          <div className="peaksecondheader">
            <nav>
              <ul>
                <li
                  className="peaklidrop"
                  onMouseEnter={() => toggleDropdown("peakproducts")}
                  onMouseLeave={() => toggleDropdown(null)}
                >
                ...
                <li
                  className="peaklidrop"
                  onMouseEnter={() => toggleDropdown("peakstart-selling")}
                  onMouseLeave={() => toggleDropdown(null)}
                >
                ...
                <li
                  className="peaklidrop"
                  onMouseEnter={() => toggleDropdown("peaktools")}
                  onMouseLeave={() => toggleDropdown(null)}
                >
                ...
                <li
                  className="peaklidrop"
                  onMouseEnter={() => toggleDropdown("peakpricing")}
                  onMouseLeave={() => toggleDropdown(null)}
                >
                ...
                <li
                  className="peaklidrop"
                  onMouseEnter={() => toggleDropdown("peakresources")}
                  onMouseLeave={() => toggleDropdown(null)}
                >
                ...
                <li className="peaklidrop">
                  <p className="boldheader  peak">Pro Sellers</p>
                </li>

                <li
                  className="peaklidrop"
                  onMouseEnter={() => toggleDropdown("peakgelato-connect")}
                  onMouseLeave={() => toggleDropdown(null)}
                >
